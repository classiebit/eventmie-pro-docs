- ## 1. Getting Started
    ...
    - [1.4 Upgrade <small class="v">v1.5</small>](/{{route}}/{{version}}/upgrade)
...
- ## 2. Admin Panel
    ...
    - [2.6 Commissions <small class="v">v1.5</small>](/{{route}}/{{version}}/admin/commissions)

- ## 3. Events
    - [3.1 Simple Events](/{{route}}/{{version}}/events/simple-events)
    - [3.2 Repetitive Events <small class="v">v1.5</small>](/{{route}}/{{version}}/events/repetitive-events)
...
- ## 4. Bookings
    ...
    - [4.5 Ticket Scanner <small class="v">v1.5</small>](/{{route}}/{{version}}/bookings/ticket-scanner)
